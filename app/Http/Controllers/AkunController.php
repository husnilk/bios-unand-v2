...
class AkunController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('akun.penerimaan.create', compact(
            'jenis',
            'akuns',
            'kodeAkunRef',
            'jenisAkun'
    ...
    public function store(Request $request)
    {
        ...
        $akunPenerimaan->jenis_akun_id = $request->input('jenis_akun_id');
    ...
    public function edit($id)
    {
        ...
        return view('akun.penerimaan.edit', compact(
            'akun',
            'kodeAkunRef',
            'jenisAkun',
            'jenis'
